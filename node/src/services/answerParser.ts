...
export interface ParsedAnswer {
  ...
  // Structured sections (extracted from answer)
  sections: Array<{
    title: string;
    content: string;
    type?: string;
  ...
  // ✅ REMOVED: UI requirements no longer decided by LLM (Perplexity-style)
  
  // Follow-up suggestions (generated by LLM)
  followUpSuggestions: string[];
  
  // Metadata
  metadata?: {
    categories?: string[]; // Detected categories (Luxury Hotels, Running Shoes, etc.)
    mentionedItems?: string[]; // Specific items mentioned (hotel names, products, etc.)
  };
}
 ...
 */
export function parseStructuredAnswer(llmResponse: string): ParsedAnswer {
  // Default values
  const defaultAnswer: ParsedAnswer = {
    answer: llmResponse,
 ...
 */
function extractSections(text: string): Array<{ title: string; content: string; type?: string }> {
 ...
 */
function extractMetadata(text: string, sections?: Array<{ title: string; content: string; type?: string }>): { categories?: string[]; mentionedItems?: string[] } {
