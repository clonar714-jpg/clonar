// src/services/passage-reranker.ts
// Lightweight reranker: scores (query, passage) via embedding cosine similarity. Optional step between retrieval and synthesis.
