...
export interface HotelProvider {
  name: string;
  search(query: string, options?: HotelSearchOptions): Promise<HotelResult[]>;
}
 ...
 */
export function buildOptimalHotelQuery(
 ...
 */
export function extractHotelFiltersFromQuery(query: string): {
  priceMax?: number;
  priceMin?: number;
  rating?: number;
  location?: string;
