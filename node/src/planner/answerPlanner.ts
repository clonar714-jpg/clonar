...
export function planAnswer(input: PlanAnswerInput): AnswerPlan {
  ...
  // ======================================================================
  let userGoal: UserGoal = "browse"; // Default

  // Decision queries: "best", "worth it", "should I", "better than"
  if (
    /\b(best|top|worth it|should i|is.*worth|is.*good|recommend|suggest)\b/i.test(query) ||
  ...
  // Learn queries: "what is", "how does", "explain", "why"
    ...
    /\b(what is|what are|how does|how do|explain|why|tell me about|describe)\b/i.test(query)
  ) {
    userGoal = "learn";
  }
  ...
  // ======================================================================
  let ambiguity: AmbiguityLevel = "low";
  ...
  // Medium ambiguity: missing context (no brand, location, category)
    ...
    !/\b(brand|location|category|price|under|above)\b/i.test(query) &&
    queryWords < 6
  ) {
    ambiguity = "medium";
  }
