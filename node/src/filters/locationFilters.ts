 ...
 */
export function extractLocationDetails(query: string): {
  city?: string;
  area?: string; // downtown, airport, beach, etc.
  neighborhood?: string;
} {
...
function locationMatches(
  locationText: string,
  filters: ReturnType<typeof extractLocationDetails>
): boolean {
  if (!locationText) return true; // If no location filter, include all
 ...
 */
export function filterHotelsByLocation(
  hotels: any[],
  query: string
): any[] {
