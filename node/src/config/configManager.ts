...
import fs from 'fs';
import { Config, ConfigModelProvider, UIConfigSections, ModelProviderUISection, UIConfigField } from './types';
import { hashObj } from '../utils/serverUtils';
  ...
  private initializeFromEnv() {
    ...
    providerConfigSections.forEach((provider) => {
      ...
      if (configured) {
        ...
        delete (newProvider as any).required;
