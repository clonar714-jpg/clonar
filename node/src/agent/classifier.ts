...
const schema = z.object({
  classification: z.object({
    ...
    showProductWidget: z
      .boolean()
      .describe('Indicates whether to show the product/shopping widget.'),
    showHotelWidget: z
      .boolean()
      .describe('Indicates whether to show the hotel widget.'),
    showPlaceWidget: z
      .boolean()
      .describe('Indicates whether to show the place/restaurant widget.'),
    showMovieWidget: z
      .boolean()
      .describe('Indicates whether to show the movie widget.'),
  }),
