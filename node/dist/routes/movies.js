...
import { searchMovies, getMovieDetails, getPopularMovies, getTrendingMovies, getMovieCredits, getMovieVideos, getMovieImages, getMovieReviews, getPersonDetails } from "../services/tmdbService.js";
...
router.get("/:id", async (req, res) => {
    try {
        ...
        try {
            ...
            const nowPlayingMovieIds = new Set(allNowPlaying.map((m) => m.id));
 ...
 */
router.post("/:id/reviews/summary", async (req, res) => {
    try {
        const movieId = parseInt(req.params.id);
