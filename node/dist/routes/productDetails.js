...
function getDefaultProductDetails(title, category) {
    return {
...
function getDefaultWhatPeopleSay(title) {
...
function getDefaultBuyThisIf(title) {
    const lowerTitle = title.toLowerCase();
    if (lowerTitle.includes("watch")) {
...
function getDefaultKeyFeatures(title, category) {
    const lowerTitle = title.toLowerCase();
    if (lowerTitle.includes("watch")) {
