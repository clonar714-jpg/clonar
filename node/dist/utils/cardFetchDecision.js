 ...
 */
export function shouldFetchCards(params) {
    ...
    if (userGoal === "browse") {
        ...
        const cardDomain = domainHint === "shopping" ? "shopping" :
 ...
 */
export function assertDecideNotShopping(userGoal, cardDomain) {
 ...
 */
export function assertDecideNotShoppingLegacy(userGoal, cardType) {
