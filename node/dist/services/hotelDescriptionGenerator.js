 ...
 */
export async function generateHotelDescription(hotelName, hotelData, sectionHeading // e.g., "Luxury downtown hotels", "Midrange options"
) {
    try {
 ...
 */
function getFallbackDescription(metadata) {
