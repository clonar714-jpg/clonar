 ...
 */
export async function extractHotelThemes(hotelName, reviews, hotelData) {
    ...
    try {
        ...
        const reviewTexts = reviews
            ...
            .filter((text) => text.length > 20) // Filter out very short reviews
 ...
 */
function inferThemesFromMetadata(hotelData) {
    const themes = [];
    if (!hotelData) {
 ...
 */
export function hasThemeSupport(theme, hotelData) {
